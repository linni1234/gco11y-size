...
var analyzerFixtureCases = []fixtureCase{
	...
	{
		Name:                     "python-service",
		AnalyzerIDs:              []string{"python"},
		ServiceNames:             []string{"python-checkout"},
		OperationCount:           25,
		EdgeCount:                14,
		DetectedLanguageContains: []string{"python"},
		RequiredOperations: []operationExpectation{
			httpOperation("python-checkout", "SERVER", "GET", "/api/v1/orders/{order_id}"),
			httpOperation("python-checkout", "SERVER", "POST", "/api/v1/orders"),
			{Service: "python-checkout", Kind: "SERVER", Protocol: "websocket", Method: "CONNECT", Route: "/api/v1/orders/stream/{client_id}"},
			httpOperation("python-checkout", "SERVER", "GET", "/api/flask/orders/{order_id}"),
			httpOperation("python-checkout", "SERVER", "ANY", "/django/orders/{order_id}"),
			httpOperation("python-checkout", "SERVER", "ANY", "/customers"),
			httpOperation("python-checkout", "SERVER", "POST", "/graphql"),
			httpOperation("python-checkout", "SERVER", "POST", "/serverless/orders"),
			{Service: "python-checkout", Kind: "SERVER", Protocol: "grpc", Method: "RPC", Route: "checkout.Greeter/SayHello"},
			{Service: "python-checkout", Kind: "CONSUMER", Protocol: "celery", Method: "MESSAGE", Route: "celery:orders.created"},
			{Service: "python-checkout", Kind: "PRODUCER", Protocol: "kafka", Method: "MESSAGE", Route: "kafka:orders.audit"},
			{Service: "python-checkout", Kind: "PRODUCER", Protocol: "sqs", Method: "MESSAGE", Route: "sqs:orders-queue"},
			{Service: "python-checkout", Kind: "INTERNAL", Protocol: "custom", Method: "SPAN", Route: "reconcile-orders"},
		},
		AbsentOperations: []operationExpectation{
			{Service: "python-checkout", Kind: "SERVER", Protocol: "grpc", Method: "RPC", Route: "Greeter/configured"},
		},
		RequiredEdges: []edgeExpectation{
			{SourceService: "python-checkout", TargetService: "postgresql:orders", Protocol: "postgresql"},
			{SourceService: "python-checkout", TargetService: "redis:redis.internal", Protocol: "redis"},
			{SourceService: "python-checkout", TargetService: "mongodb:orders", Protocol: "mongodb"},
			{SourceService: "python-checkout", TargetService: "qdrant:orders-vectors", Protocol: "qdrant"},
			{SourceService: "python-checkout", TargetService: "inventory-service.internal", Protocol: "http"},
			{SourceService: "python-checkout", TargetService: "inventory-grpc.internal", Protocol: "grpc"},
			{SourceService: "python-checkout", TargetService: "celery:billing.commands", Protocol: "celery"},
			{SourceService: "python-checkout", TargetService: "kafka:orders.audit", Protocol: "kafka"},
			{SourceService: "python-checkout", TargetService: "sqs:orders-queue", Protocol: "sqs"},
		},
		DetectorExpectations: []detectorExpectation{
			{
				Operation: httpOperation("python-checkout", "SERVER", "GET", "/api/v1/orders/{order_id}"),
				Required:  []string{"fastapi"},
			},
			{
				Operation: operationExpectation{Service: "python-checkout", Kind: "SERVER", Protocol: "grpc", Method: "RPC", Route: "checkout.Greeter/SayHello"},
				Required:  []string{"protobuf", "grpc-python"},
			},
		},
		RequiredConfigFindings: []configFindingExpectation{
			{Kind: "service-name", Name: "project.name", Value: "python-checkout"},
			{Kind: "python-web-framework", Name: "fastapi", Value: "detected"},
			{Kind: "python-dependency-framework", Name: "sqlalchemy", Value: "detected"},
			{Kind: "python-dependency-framework", Name: "qdrant-client", Value: "detected"},
			{Kind: "python-messaging-framework", Name: "celery", Value: "detected"},
			{Kind: "instrumentation", Name: "opentelemetry-python", Value: "detected"},
		},
		RequiredRiskAreas: []string{"span attributes"},
	},
	{
		Name:                     "python-library-only",
		AnalyzerIDs:              []string{"python"},
		ServiceNames:             []string{"python-library-only"},
		OperationCount:           0,
		EdgeCount:                0,
		DetectedLanguageContains: []string{"python"},
		AbsentOperations: []operationExpectation{
			httpOperation("python-library-only", "SERVER", "GET", "/should-not-count"),
			httpOperation("python-library-only", "SERVER", "ANY", "/migration/route"),
			{Service: "python-library-only", Kind: "SERVER", Protocol: "grpc", Method: "RPC", Route: "Greeter/configured"},
		},
	},
	{
